properties {
	...
	$sln_file = "killbill-client-net.sln"
...
task CreateNuGetPackage -depends Compile {
	...
	md $dist_directory
	exec { . $nuget_path pack $src_directory\killbill-client-net\killbill-client-net.csproj -o $dist_directory -version $packageVersion }	
}